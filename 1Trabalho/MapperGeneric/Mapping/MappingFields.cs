...
namespace MapperGeneric {
    public class MappingFields : Mapping {
        ...
        public override void Map(object srcObject, object destObject, Dictionary<string, string> dict, Dictionary<string, object> dictResult) {
        ...
        public override void Map(object srcObject, object destObject, Type attr, Dictionary<string, string> dict, Dictionary<string, object> dictResult) {
